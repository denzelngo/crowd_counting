...
if which == 'student':
    ...
    lit_vgg_distill = LitVGGDistill.load_from_checkpoint('vgg_student_best_mae_nwpu_pretrain_new.ckpt')
...
img_path = '../Crowd_Counting_dataset/ShanghaiTech_Crowd_Counting_Dataset/part_B_final/test_data/images'
gt_path = '../Crowd_Counting_dataset/ShanghaiTech_Crowd_Counting_Dataset/part_B_final/test_data/ground_truth'
img_listdir = os.listdir(img_path)
n = len(img_listdir)
img_listdir.sort(key=lambda x: int(x[4:-4]))
gt_dict = {}
img_to_save = []
n_mea = 0
s_mea = 0
